          ...
          <div class="title-infos">
            ...
            <div v-if="author || published" class="subtitle">
              ...
              <template v-if="published">
                <i class="icon icon-ellipse-33 icon--s4 hideable-hidden"></i>
      ...
      <div class="title-card-details-sub">
        ...
        <div v-if="genres || likes" class="row-end justify-between">
          <div v-if="genres || contentRating" class="row-middle hideable-hidden genres-list">
            ...
            <div v-if="contentRating" class="badge badge-content-rating" v-text="contentRating" />
          </div>
          <div class="row-middle">
            <div v-if="likes" class="stat-item stat-item-md">
              <i class="icon icon-favorite icon--s12"></i>
              <span>
                {{ likes }}
              </span>
            </div>
